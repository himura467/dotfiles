...
test-installers:
	...
	@command -v rustup > /dev/null && echo 'OK. rustup is installed.' || (echo 'FAIL. rustup is not installed.' && exit 1)
	@command -v rustc > /dev/null && echo 'OK. rustc is installed.' || (echo 'FAIL. rustc is not installed.' && exit 1)
	@command -v cargo > /dev/null && echo 'OK. cargo is installed.' || (echo 'FAIL. cargo is not installed.' && exit 1)
